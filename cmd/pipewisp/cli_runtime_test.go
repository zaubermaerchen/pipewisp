...
func TestRunCLIHelp(t *testing.T) {
	...
	if got, want := output.String(), "Usage: pipewisp [--on COMMAND] [--on-first-data COMMAND] [--off COMMAND] [--idle DURATION] [--on-idle COMMAND] [--on-resume COMMAND] [--hook-timeout DURATION]\n"; got != want {
