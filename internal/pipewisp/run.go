// Package pipewisp implements the pipewisp CLI runtime and stream lifecycle.
package pipewisp

// This file owns the public CLI runtime entry point and its lifecycle wiring.
...
// Run executes pipewisp with the supplied command-line arguments and streams.
// It returns the process exit status without calling os.Exit.
